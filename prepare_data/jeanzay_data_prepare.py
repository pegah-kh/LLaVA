...
original_path = '/home/khayatan/llava/prepare_data/llava_coco_action_correct.json'
dest_path = '/home/khayatan/llava/prepare_data/llava_coco_action_jeanzay.json'
...
def update_image_paths(input_file, output_file):
    ...
    old_base_path = '/data/mshukor/data/coco'
    new_base_path = '/gpfsdswork/dataset/COCO'
